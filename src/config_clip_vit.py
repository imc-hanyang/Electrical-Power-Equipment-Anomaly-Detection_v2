...
_C.MODEL.pooling_mode = 'mean'
_C.MODEL.topk_ratio = 0.10
_C.MODEL.attention_hidden_dim = 192
_C.MODEL.mil_roi_top = 0.28
_C.MODEL.mil_roi_bottom = 0.72
_C.MODEL.mil_gate_init = 0.10
